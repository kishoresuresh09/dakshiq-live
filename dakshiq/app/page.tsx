    ...
    <main className="min-h-screen bg-[#050816] text-white overflow-x-hidden">
          ...
          <div className="w-full flex justify-center lg:justify-end lg:-mt-4">
            ...
            <div className="bg-[#0d1326] border border-[#1a2338] rounded-[32px] p-8 lg:p-10 shadow-2xl w-full max-w-xl">
              ...
              <div className="space-y-5">
                ...
                <div className="bg-[#111827] border border-[#1f2937] rounded-2xl p-5 flex items-center text-lg">
                  🚗
                  <span className="ml-4">
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-10 py-20">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 text-lg mt-5 max-w-2xl mx-auto">
            Build verified workforce profiles and improve employability for future-ready automotive careers.
          </p>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="bg-[#0d1326] border border-[#1a2338] rounded-[28px] p-8">
            ...
            <p className="text-gray-400 leading-relaxed text-lg">
              ...
              diagnostic skills, and workforce readiness.
            </p>
          ...
          <div className="bg-[#0d1326] border border-[#1a2338] rounded-[28px] p-8">
            ...
            <p className="text-gray-400 leading-relaxed text-lg">
              Understand strengths, skill gaps, and career readiness for dealership ecosystems.
            </p>
          ...
          <div className="bg-[#0d1326] border border-[#1a2338] rounded-[28px] p-8">
            ...
            <p className="text-gray-400 leading-relaxed text-lg">
              Build future-ready profiles for EV and AI-driven automotive service operations.
            </p>
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-10 py-20">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 text-lg mt-5 max-w-2xl mx-auto">
            Workforce intelligence for future-ready aftersales operations.
          </p>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="bg-[#0d1326] border border-[#1a2338] rounded-[28px] p-8">
            ...
            <p className="text-gray-400 leading-relaxed text-lg">
              Benchmark workforce capability and identify critical skill gaps.
            </p>
          ...
          <div className="bg-[#0d1326] border border-[#1a2338] rounded-[28px] p-8">
            ...
            <p className="text-gray-400 leading-relaxed text-lg">
              Discover skill-verified candidates and workforce readiness indicators.
            </p>
          ...
          <div className="bg-[#0d1326] border border-[#1a2338] rounded-[28px] p-8">
            ...
            <p className="text-gray-400 leading-relaxed text-lg">
              Track workforce preparedness for EV transition and advanced diagnostics.
            </p>
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-10 py-20">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-[36px] p-10 lg:p-16 text-center shadow-2xl">
          ...
          <h2 className="text-4xl lg:text-6xl font-bold leading-tight max-w-5xl mx-auto">
          ...
          <p className="text-blue-100 text-lg lg:text-xl mt-8 leading-relaxed max-w-3xl mx-auto">
